...
<div class="no-page-container">
    ...
    <div class="no-page-row">
        <div class="no-page-head">
            <h1 class="no-heading-sm">주문자 관리</h1>
            <p class="no-text-secondary">등록된 주문자 정보를 확인하실 수 있습니다.</p> 
        </div>
        <!-- Head -->
        ...
        <div class="no-page-index-filter">
            ...
            <div class="no-page-index-link">
                <a href="<?=route('guests.create')?>" class="no-btn-primary --sm">
                    <span>Create</span>
                </a>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr class="no-table-hover">
                        <td class="no-table-check">
                            <div class="no-form-checkbox --xs">
                                <label for="user<?=$i?>" class="no-form-checkbox-pointer">
                                    <input type="checkbox" id="user<?=$i?>" class="no-form-checkbox-input">
                                    <div class="no-form-checkbox-ripple">
                                        <span class="no-form-checkbox-box">
                                            <div class="no-form-checkbox-icon">
                                                <i class="fa-solid fa-check"></i>
                        ...
                        <td class="no-table-action">
                            <div class="no-page-index-table__action">
                                ...
                                <a href="<?=url('guests.edit', ['id' => $i])?>" class="no-btn-action" data-tooltip>
                                    <div class="no-btn-action-ripple">
