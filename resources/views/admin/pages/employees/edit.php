...
<div class="no-form-container">
    ...
    <div class="no-page-row">
        ...
        <div class="no-form-tabs" data-tab="form-content">
            <button type="button" class="no-form-tab --active">계정정보</button>
            <button type="button" class="no-form-tab">비밀번호</button>
        </div>
        
        <div class="no-form-tab-content" id="form-content">
            ...
            <form method="post" enctype="multipart/form-data" action="<?= route('notices.store') ?>">
                <div class="no-form-group">
                    ...
                    <div class="no-form-control --md --password">
                        <label for="new_password" class="no-form-control-inner">
                            <input type="password" name="new_password" id="new_password" class="no-form-control-input" placeholder="" >
                            <fieldset class="no-form-control-label">
                                <legend class="no-form-control-text">새 비밀번호</legend>
                            </fieldset>
                            <div class="no-form-password-icon">
                                <button class="no-form-password-button no-btn-icon --xs" type="button" data-password-button="#new_password">
                                    <i class="fa-regular fa-eye-slash"></i>
                                </button>
                            </div>
                        </label>
