...
<div class="no-page-container">
    ...
    <div class="no-page-row">
        <div class="no-page-head">
            <h1 class="no-heading-sm">대리점관리</h1>
            <p class="no-text-secondary">등록된 대리점 정보를 확인하실 수 있습니다.</p> 
        </div>
        <!-- Head -->
        ...
        <div class="no-page-index-filter">
            ...
            <div class="no-page-index-link">
                <a href="<?=route('agents.create')?>" class="no-btn-primary --sm">
                    <span>Create</span>
                </a>
            </div>
        </div>
