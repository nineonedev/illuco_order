...
export default class CustomerSelection extends View {
    ...
    _bindEvents(){
        ...
        const inputs = this.qsAll('#search-form input');
        inputs.forEach(input => {
            this.on(input, 'input', Helper.debounce(this._handleSearch.bind(this), 500));
        });
    ...
    _handleMove(button, evt) {
        ...
        if (this._state.paginator.per_page) params.append('perpage', this._state.paginator.per_page);
